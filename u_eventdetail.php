        ...
        {       
            ...
            while ($row_tktinfo3 = mysqli_fetch_array($Tktinfo3)) 
            {
                if($_POST["tkttype"] == $row_tktinfo3[1])
                {
                    ...
                    header("Location:user_activity.php?orderStats=1");
                }       
            }
        }
    }
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                        ...
                        <form name="gettktform" method="post" action="u_eventdetail.php?concertid=<?php echo $_GET["concertid"];?>" class="form-horizontal">              
